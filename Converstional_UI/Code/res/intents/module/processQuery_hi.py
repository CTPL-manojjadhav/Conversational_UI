...
picklePath=os.path.join(scriptDir,'..','model',domain+'_hi_')
...
stopwordFile=os.path.join(scriptDir,'..','..','dictionary','stopwords_hi.txt')
arrayWords=[]
stopWords=[]
...
def processUtterance(utter):
 ...
 return response
synonymFile=os.path.join(scriptDir,'..','..','dictionary','synonyms_hi.txt')
