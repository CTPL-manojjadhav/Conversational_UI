...
stopwordFile=os.path.join(scriptDir,'..','..','dictionary','stopwords_nl.txt')
arrayWords=[]
stopWords=[]
...
stopwordList=set(stopwords.words('dutch'))|swList
...
def processUtterance(utter):
 ...
 return response
synonymFile=os.path.join(scriptDir,'..','..','dictionary','synonyms_nl.txt')
