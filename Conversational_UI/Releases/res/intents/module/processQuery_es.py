...
picklePath=os.path.join(scriptDir,'..','model',domain+'_es_')
...
stopwordFile=os.path.join(scriptDir,'..','..','dictionary','stopwords_es.txt')
arrayWords=[]
stopWords=[]
...
stopwordList=set(stopwords.words('spanish'))|swList
...
def processUtterance(utter):
 ...
 return response
synonymFile=os.path.join(scriptDir,'..','..','dictionary','synonyms_es.txt')
