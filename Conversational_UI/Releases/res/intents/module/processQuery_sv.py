...
picklePath=os.path.join(scriptDir,'..','model',domain+'_sv_')
...
stopwordFile=os.path.join(scriptDir,'..','..','dictionary','stopwords_sv.txt')
arrayWords=[]
stopWords=[]
...
stopwordList=set(stopwords.words('swedish'))|swList
...
def processUtterance(utter):
 ...
 return response
synonymFile=os.path.join(scriptDir,'..','..','dictionary','synonyms_sv.txt')
