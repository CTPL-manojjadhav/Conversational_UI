...
picklePath=os.path.join(scriptDir,'..','model',domain+'_da_')
...
stopwordFile=os.path.join(scriptDir,'..','..','dictionary','stopwords_da.txt')
arrayWords=[]
stopWords=[]
...
stopwordList=set(stopwords.words('danish'))|swList
...
def processUtterance(utter):
 ...
 return response
synonymFile=os.path.join(scriptDir,'..','..','dictionary','synonyms_da.txt')
