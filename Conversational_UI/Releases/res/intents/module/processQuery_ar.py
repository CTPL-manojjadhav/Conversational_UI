...
picklePath=os.path.join(scriptDir,'..','model',domain+'_ar_')
...
stopwordFile=os.path.join(scriptDir,'..','..','dictionary','stopwords_ar.txt')
arrayWords=[]
stopWords=[]
...
stopwordList=set(stopwords.words('arabic'))|swList
...
def processUtterance(utter):
 ...
 return response
synonymFile=os.path.join(scriptDir,'..','..','dictionary','synonyms_ar.txt')
