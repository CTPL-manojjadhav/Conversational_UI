...
from module import stemmer_sv
vectorDimension=200
domain=sys.argv[1]
scriptDir=os.path.dirname(__file__)
fileData=os.path.join(scriptDir,'data',domain+'_sv.json')
utterance=[]
intent=[]
...
stopListFile=os.path.join(scriptDir,'..','dictionary','stopwords_sv.txt')
arrayWords=[]
stopWords=[]
...
tfidfVec=TfidfVectorizer(utterance,decode_error='ignore',stop_words=stops,ngram_range=(1,5),tokenizer=stemmer_sv.stemTokenize_1)
...
pickle_path=os.path.join(scriptDir,'model',domain+'_sv_')
