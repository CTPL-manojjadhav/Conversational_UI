...
from module import stemmer_ar
vectorDimension=200
domain=sys.argv[1]
scriptDir=os.path.dirname(__file__)
fileData=os.path.join(scriptDir,'data',domain+'_ar.json')
utterance=[]
intent=[]
...
stopListFile=os.path.join(scriptDir,'..','dictionary','stopwords_ar.txt')
arrayWords=[]
stopWords=[]
...
tfidfVec=TfidfVectorizer(utterance,decode_error='ignore',stop_words=stops,ngram_range=(1,5),tokenizer=stemmer_ar.stemTokenize)
...
pickle_path=os.path.join(scriptDir,'model',domain+'_ar_')
